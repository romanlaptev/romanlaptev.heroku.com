...
"url": "https://api.rasp.yandex.net/v3.0/copyright/?apikey=b07a64bc-f237-4e79-9efb-b951ec68eaf7&format=json", "data": ""
		},
...
*/
			...
			"dataUrl" : "https://api.rasp.yandex.net/v3.0/search/?\
from={{from_code}}&\
to={{to_code}}&\
apikey={{apikey}}&\
date={{date}}&\
...
console.log("init webapp!");
		...
		var today = func.timeStampToDateStr( new Date(), "yyyy-mm-dd" );
//console.log(today);
...
*/
	...
	func.runAjax( {
		...
		"url" :  webApp.vars["proxyUrl"], 
		"params" : {
			"request_url" : webApp.vars["copyRight"]["url"]
		},
		"onLoadEnd" : function( headers ){
//console.log( headers );
		},
